...
function SquareFunctional() {
  ...
  const setCoords1 = (evt: React.MouseEvent) => {
    evt.persist();
    setSquare1((prev) => {
  ...
  const setCoords2 = (evt: React.MouseEvent) => {
    evt.persist();
    // Multiple call
    setSquare2({ x: 0, y: 0 });
    setSquare2({ x: 0, y: 0 });
  ...
  return (
    <div className="column full-width center m-bottom-4">
      ...
      <div className="row">
        <div
          className="column middle center square m-right-4"
          onClick={setCoords1}
        >
        ...
        <div className="column middle center square" onClick={setCoords2}>
          <p className="bold">Mouse position</p>
